  ...
  void arrancar_servidor_web(){
    ...
    /*  ACTUADOR ENCHUFE  */
    servidorWeb.on("/enchufe/encender",manejadorEncendidoEnchufe); // Asociar el path "enchufe/encender" a la funcion menajadorEncendido()
    servidorWeb.on("/enchufe/apagar",manejadorApagadoEnchufe); // Asociar el path "enchufe/apagar" a la funcion manejadorApagado()
    servidorWeb.on("/enchufe/estado",manejadorEstadoEnchufe); // Asociar el path "enchufe/estado" a la funcion manejadorApagado()
  ...
  /* Esta funcion se encarga de mostrar el estado del pin del ACTUADOR ENCHUFE */
